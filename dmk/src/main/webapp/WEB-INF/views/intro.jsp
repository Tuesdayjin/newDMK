								...
								<span style="font-size: 16px; font-family: 'NanumSquare';">
								 ...
								 <div class="slider-1">
							        <div class="slides"  style="display: inline-block; width: auto;" >
							            ...
							            <div class="videoslide" style="display: inline-block; height: auto;" >
							                <video id="videoplay3" src="http://localhost:8081/front/sky.mp4" muted autoplay loop style="width: 700px; height: auto; display: block; margin: 0 auto;"></video>
							            </div>
							        </div>
							        <div class="page-btns">
							            <div ></div>
								  ...
								  <img alt="" src="http://localhost:8081/front/floatleft.jpg" style="width: 100%;height: auto;" >
								    ...
								    <div class="card">
								      <div class="card-body" style="background-color: #FFFFFf; height:430px; padding-left:18%;">
								        ...
								        <a id="linkupload" class="btn btn-primary cardbtn" style="top:30px; border:0.8px;   border-style: solid; border-color: #FAC95E; color:#FAC95E;">링크로 찾기</a>
								      </div>
								    </div>
								  </div>
								  <div class="col-sm-4"  style="position: relative;">
								  ...
								  <img alt="" src="http://localhost:8081/front/floatright.jpg" style="position: absolute; width: auto;height: 100%; left:-80px;" >
								    ...
								    <div class="card">
								      <div class="card-body" style="background-color: #FFFFFf; height:430px;  padding-right:18%;">
								        ...
								        <a id="fileupload" class="btn btn-primary cardbtn" style="top:30px; border:0.8px;   border-style: solid; border-color: #FAC95E; color:#FAC95E;" >파일로 찾기</a>
								    </div>
								  </div>
								</div>
							</div>
